...
__ANS__
1.Docker ใช้งานง่าย ไม่ต้องติดตั้งเยอะ ส่วน Native ยุ่งยาก ต้องลงเองทุกอย่าง
2.Mount code → รัน idf.py build → CMake+Ninja → ได้ binary
3.บอกว่าโค้ดอยู่ไหน ต้อง build อะไร ใช้ CMake อ่านตอน build
4.กันไฟล์ขยะเข้า Git ให้ repo สะอาด
5.ไฟล์ใน container หาย และไฟล์ในโฟลเดอร์ hostอยู่
6.Docker พร้อมใช้ทันที แต่Native ต้อง setup เองก่อน
