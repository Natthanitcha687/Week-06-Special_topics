...
__ANS__
1.เพราะทำให้แยกโค้ดให้อ่านง่าย แก้ง่าย จัดการง่าย
2.แก้ด้วยการเพิ่มชื่อไฟล์ใหม่ใน SRCS และ INCLUDE_DIRS ถ้ามี header
3.บอกว่าโค้ดฟังก์ชันอะไรมีให้ใช้ ช่วยให้โมดูลเรียกกันได้
4.ให้ CMake รู้ว่าจะหา .h จากที่ไหน
5.กันไฟล์ build ขยะไม่ให้เข้า Git
6.ทำให้ LED ทำงานแยกอิสระ ไม่รบกวน task อื่น
7.โค้ดดูเป็นระบบ เพิ่ม-แก้ง่าย แยกหน้าที่ชัดเจน
...
## 💡 บันทึกผลการทดลอง
ปล.reportผลการทดลองอยู่ในโฟลเดอร์ simulate-report

**ขั้นตอนที่ 1 (เฉพาะ sensor.c):**
- จำนวนไฟล์ source: 1
- ขนาด binary: 267,296 bytes
- การทำงาน: แสดงไฟล์ & บรรทัด, สุ่มค่าอุณหภูมิ-ความชื้น, log สถานะเซ็นเซอร์

**ขั้นตอนที่ 2 (เพิ่ม display.c):**
- จำนวนไฟล์ source: 2
- ขนาด binary: 268,480 bytes
- การทำงาน: เพิ่มโมดูล display มาแสดงผลลัพธ์ เช่น ข้อความหรือค่าต่าง ๆ บนหน้าจอ โดยแต่ละฟังก์ชัน log ว่ามาจากไฟล์ไหน บรรทัดไหน พร้อม emoji บอกสถานะ

**ขั้นตอนที่ 3 (เพิ่ม led.c):**
- จำนวนไฟล์ source: 3
- ขนาด binary: 270,768 bytes
- การทำงาน:  ควบคุมไฟ LED ได้ เช่น เปิด, ปิด, สลับสถานะ, และกระพริบอัตโนมัติ

**สังเกต:**
- การเพิ่มไฟล์ source ส่งผลต่อขนาด binary อย่างไร?
__ตอบ__ ไฟล์ .bin ขนาดเพิ่มขึ้นทุกครั้งที่เพิ่มไฟล์ .c
- LED กะพริบทุกกี่วินาที?
__ตอบ__ กะพริบทุก1วินาที
- แต่ละโมดูลแสดงข้อมูล file และ line อย่างไร?
__ตอบ__ fileแสดงชื่อไฟล์ และlineแสดงเลขบรรทัด
